# -*- coding: utf-8 -*-
"""Hermione Grander.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1N9p7v-HKAnnsSgpoisIIompEBy13x1il
...
data=pd.read_csv("/content/drive/MyDrive/HarryPotter1.csv",sep=';')
...
main(trn_df, val_df)
#perplexity ie confusion for epoch 4=7.0535; 6=5.1835; 8=4.8286; 10=5.9901; 12=;
...
for step in range(4):
    ...
    print("HermioneBot: {}".format(tokenizer.decode(chat_history_ids[:, bot_input_ids.shape[-1]:][0], skip_special_tokens=True)))
...
!huggingface-cli repo create DialoGPT-medium-HermioneGrander

!sudo apt-get install git-lfs

!git config --global user.email "rujutajoshi16@gmail.com"
# Tip: using the same email as your huggingface.co account will link your commits to your profile
!git config --global user.name "fujuta"

MY_MODEL_NAME = 'DialoGPT-medium-HermioneGrander'
HUGGINGFACE_API_KEY = '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'
